...
class RunController extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->assign('scroll', array(
            array('sk***','长期宝','喜中2000.00'),
            array('火红***','短期宝','喜中60.00'),
            array('心之***','长期宝','喜中2000.00'),
            array('檀越***','长期宝','喜中200.00'),
            array('胡敏***','长期宝','喜中20.00'),
            array('八月***','短期宝','喜中180.00'),
            array('农民***','长期宝','喜中60.00'),
            array('💔***','短期宝','喜中4000.00'),
            array('嗨！***','长期宝','喜中20.00'),
            array('Al***','短期宝','喜中2000.00'),
            array('【E***','长期宝','喜中400.00'),
            array('***', '短期宝','喜中10.00'),
            array('廖若***','短期宝','喜中200.00'),
            array('花开***','短期宝','喜中120.00'),
            array('菩提***','短期宝','喜中200.00'),
            array('修缘***','短期宝','喜中80.00'),
            array('晓瀞***','短期宝','喜中4000.00'),
            array('惠通***','短期宝','喜中2000.00'),
            array('小明***','短期宝','喜中200.00'),
            array('【如***','短期宝','喜中20.00'),
            array('00***','短期宝','喜中80.00'),
            array('白及***','短期宝','喜中60.00'),
            array('天人***','短期宝','喜中40.00'),
            array('大王***','短期宝','喜中1000.00'),
            array('人心***','短期宝','喜中1600.00'),
            array('奋斗***','短期宝','喜中200.00'),
            array('刘光***','短期宝','喜中40.00'),
            array('El***','短期宝','喜中1000.00'),
            array('雪泥***','长期宝','喜中1000.00'),
            array('十***','长期宝','喜中1000.00'),
            array('阳光***','长期宝','喜中2000.00'),
            array('👄***','长期宝','喜中2000.00'),
            array('寻找***','短期宝','喜中90000.00'),
            array('单身***','长期宝','喜中128.00'),
            array('Lu***','长期宝','喜中30.00'),
            array('李玉***','长期宝','喜中10.00'),
            array('安興***','短期宝','喜中40.00'),
            array('楠楠***','短期宝','喜中200.00'),
            array('东***','短期宝','喜中1600.00'),
            array('魔力***','长期宝','喜中200.00'),
            array('梦琪***','短期宝','喜中20.00'),
            array('大叔***','短期宝','喜中400.00'),
            array('进无***','短期宝','喜中800.00'),
            array('法兰***','短期宝','喜中1600.00'),
            array('刘福***','短期宝','喜中20.00'),
            array('婷，***','短期宝','喜中200.00'),
            array('简单***','长期宝','喜中400.00'),
            array('共清***','长期宝','喜中1000.00'),
            array('李白***','长期宝','喜中40.00'),
            array('六排***','短期宝','喜中340.00'),
            array('张丽***','短期宝','喜中20.00'),
            array('友缘***','短期宝','喜中20.00'),
            array('Mi***','短期宝','喜中4000.00'),
            array('我非***','长期宝','喜中20.00'),
            array('A��***','短期宝','喜中20.00'),
            array('🐍***','短期宝','喜中240.00'),
            array('港琪***','短期宝','喜中100.00'),
            array('空帅***','短期宝','喜中1400.00'),
            array('喆***','长期宝','喜中20.00'),
            array('ki***','短期宝','喜中4000.00'),
            array('踊跃***','短期宝','喜中3000.00'),
            array('麦田***','短期宝','喜中4256.00'),
            array('晨晨***','短期宝','喜中79.00'),
            array('北觅***','短期宝','喜中250.00'),
            array('幸福***','长期宝','喜中41.00'),
            array('晨晨***','长期宝','喜中79.00'),
            array('肆无***','长期宝','喜中30000.00'),
            array('约翰***','短期宝','喜中600.00'),
            array('情绪***','短期宝','喜中200.00'),
            array('百昧***','长期宝','喜中200.00'),
            array('庸人***','长期宝','喜中2000.00'),
            array('春素***','长期宝','喜中250.00'),
            array('偏执***','长期宝','喜中20.00'),
            array('时光***','短期宝','喜中600.00'),
            array('梦里***','短期宝','喜中2000.00'),
            array('房子***','短期宝','喜中48.00'),
            array('欣欣***','长期宝','喜中180.00'),
            array('大红***','短期宝','喜中20.00'),
            array('八***','短期宝','喜中3000.00'),
            array('～心***','短期宝','喜中180.00'),
            array('八九***','短期宝','喜中4000.00'),
            array('谁***','短期宝','喜中120.00'),
            array('余生***','短期宝','喜中1200.00'),
            array('有一***','短期宝','喜中5000.00'),
            array('以静***','短期宝','喜中10000.00'),
            array('贝拉***','短期宝','喜中40.00'),
            array('落幕***','短期宝','喜中2000.00'),
            array('君子***','短期宝','喜中2000.00'),
            array('小迷***','短期宝','喜中20750.00'),
            array('ʘᴗ***','短期宝','喜中33200.00'),
            array('go***','短期宝','喜中400000.00'),
            array('知足***','短期宝','喜中400.00'),
            array('时光***','短期宝','喜中2000.00'),
            array('阿诚***','长期宝','喜中500.00'),
            array('清清***','长期宝','喜中200.00'),
            array('登记***','短期宝','喜中400.00'),
            array('👑***','短期宝','喜中20.00'),
            array('勇往***','短期宝','喜中6000.00'),
            array('男志***','短期宝','喜中2000.00'),
            array('露露***','短期宝','喜中2000.00'),
        ));
        if (C('index_page') == '1') {
