...
class SiteController extends BaseController {
	...
	public function ajax_short_url(){
	    $url = I('url');
	    //$content = file_get_contents('http://kndwz.com/api-tcn.php?link='.$url);
	    $content[]['url_short'] = $url;
		
	    return $this->ajaxReturn(json_encode($content));
    }
}
